...
if __name__ == '__main__':
    ...
    with open (path + '/top2_bottom1_permutation.yaml','w') as hand_permutation:
                        ...
                        for k in range(0,len(top_members[per[i][1]])):
                            for bottom_member in bottom_members:
                                ...
                                for m in range(0,len(bottom_members[bottom_member])):
                                    ...
                                    hand_per.append([top_members[per[i][0]][j], top_members[per[i][1]][k], bottom_members[bottom_member][m]])
